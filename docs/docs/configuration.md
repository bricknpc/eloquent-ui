...
The configuration options inside the config file are all documented in the file itself. Each component will also 
explain the options that are relevant for that component.